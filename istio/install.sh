...
if [[ "$SVC" ]]; then
  ...
  -f https://raw.githubusercontent.com/imaginekube/kubernetes-marketplace/master/istio/istiod-service.yaml
fi;

curl -sSL https://raw.githubusercontent.com/imaginekube/kubernetes-marketplace/master/istio/control-plane.yaml | \
...
curl -sSL https://raw.githubusercontent.com/imaginekube/kubernetes-marketplace/master/istio/ingress-gateways.yaml | \
